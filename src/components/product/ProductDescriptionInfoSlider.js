  ...
  return (
    <div className="product-details-content pro-details-slider-content">
      ...
      <div className="product-details-price justify-content-center">
        {product?.discountable !== null ? (
          <Fragment>
            <span>-{product?.variants[0]?.metadata?.discount_value}{product?.variants[0]?.metadata?.discount_type === "percentage" ? "%" : `${region?.currency_code}`}</span>{" "}
          </Fragment>
        ) : (
        ...
        <div className="pro-details-size-color justify-content-center">
          <div className="pro-details-color-wrap">
            ...
            <div className="pro-details-color-content">
              {product?.options.map((single, key) => {
                return (
                  <label
                    className={`pro-details-color-content--single ${single?.title}`}
                    key={key}
                  >
                    <input
                      type="radio"
      ...
      {product?.affiliateLink ? (
        ...
        <div className="pro-details-quality justify-content-center">
          ...
          <div className="pro-details-cart btn-hover">
            {product?.variants[0]?.inventory_quantity && product?.variants[0]?.inventory_quantity > 0 ? (
              <button
                // onClick={() =>
                //   dispatch(addToCart({
                //     ...product,
                ...
                //   }))
                // }
                disabled={productCartQty >= product?.variants[0]?.inventory_quantity}
              >
                {" "}
                Add To Cart{" "}
              </button>
